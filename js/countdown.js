(() => {
  ...
  const stages = [
    {
      until: new Date('2026-07-02T18:00:00+09:00'),
      label: '접수 마감까지',
      meta: '2026.07.02(목) 18:00 마감',
    },
    {
      until: new Date('2026-07-15T00:00:00+09:00'),
      label: '1차 결과 발표까지',
      meta: '2026.07.15(수) 개별 통보',
    },
    {
      until: new Date('2026-07-29T00:00:00+09:00'),
      label: '본선 평가까지',
      meta: '2026.07.29(수) 대면평가 · 시상식',
    },
  ];
